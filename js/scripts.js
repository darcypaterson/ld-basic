...
var searchy = document.getElementById('searchMainMenu');
...
function showSearch() {
    ...
    if ( searchy.classList.contains('d-none') == true ) {

        searchy.classList.remove('d-none');
        magGlass.classList.add('d-none');
        searchy.classList.add('d-flex');

    } else if (searchy.classList.contains('d-none') == false ) {

        searchy.classList.add('d-none');
        magGlass.classList.remove('d-none');
        searchy.classList.remove('d-flex');
...
function toggleOpenClose() {
	...
	// if ( (saveEmail.contains('bottomPosClosed')) &&! ( saveEmail.contains('bottomPosOpen')) )  {

	// 	saveEmail.add('bottomPosOpen');

	// } else if ( (saveEmail.contains('bottomPosClosed')) && (saveEmail.contains('bottomPosOpen')) ) {

	// 	saveEmail.remove('bottomPosOpen');
	// 	saveEmail.add('bottomPosOpenReverse');
